...
const CreatePost = () => {
    ...
    const { handleImageChange, setSelectedFile, selectedFile } = usePreviewImage();
                ...
                <ModalBody pb={6}>
                    ...
                    {selectedFile && (
                        <Flex mt={5} w={'full'} position={'relative'} justifyContent={'center'} >
                            ...
                            <CloseButton border={'1px solid black'} position={"absolute"} top={2} right={2} onClick={() => { setSelectedFile(""); }} />
                        </Flex>
                    )}
                </ModalBody>
