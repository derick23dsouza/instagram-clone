        ...
        return (
            <Flex gap={{ base: 4, sm: 10 }}
                ...
                <AvatarGroup size={{ base: 'xl', md: '2xl' }} justifySelf={'center'} alignSelf={'flex-start'} mx={'auto'}>
                    <Avatar src={userProfile.profilePicURL} alt='d23' />
                </AvatarGroup>
                <VStack alignItems={'start'} gap={2} mx={'auto'} flex={1}>
                    <Flex gap={4}
                        ...
                        {visitingAnotherProfileAndAuth && (
                            <Flex gap={4} alignItems={'center'} justifyContent={'center'}>
                                <Button bg={isFollowing?'black':'blue.500'} color={'white'} _hover={isFollowing?{bg:'white', color:'black'} :{ bg: 'blue.600', }}
                                border={isFollowing?'1px solid white': null} 
                                size={{ base: 'xs', md: 'sm' }}
