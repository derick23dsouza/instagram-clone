...
const ProfilePost = ({ post }) => {
    ...
    const handleDeletePost = async()=>{
        ...
        if(!window.confirm("Are you sure you would like to delete this post?")) return;
        ...
        try { 
            ...
            showToast("Success", "Post Successfully Deleted", "success")
    ...
    return (<>
        <GridItem cursor={'pointer'}
            ...
            aspectRatio={1 / 1}
            onClick={onOpen}>
            <Flex opacity={0} _hover={{ opacity: 1 }}
